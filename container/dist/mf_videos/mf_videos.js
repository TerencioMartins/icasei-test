...
class MFVideos extends HTMLElement {
  constructor() {
    ...
    this.searchIcon = this.root.querySelector("#mf_videos_search_input-icon");
  ...
  addEventListeners() {
    this.videoSearchInput.addEventListener("input", (e) => {
      ...
      this.toggleSearchIconState(isEmpty);
    });
  ...
  createHTML() {
    this.root.innerHTML = `
      ...
      <div class="mf_videos_container">
        <div id="mf_videos_search_input" class="input-container disabled">
            <input type="text" id="video-search" class="input-box" placeholder="Pesquisar">
            <svg id="mf_videos_search_input-icon" class="disabled" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24">
